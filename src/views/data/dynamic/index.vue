<!--
 * @Date: 2022-10-31
 * @LastEditTime: 2022-11-14 14:37:07
 * @LastEditors: xkloveme
 * @FileDesc:清廉动态
 * @FilePath: /js-web/src/views/data/dynamic/index.vue
 * @Copyright © xkloveme
-->
<template>
  <div class="main p-4">
    <el-form :model="queryParams" ref="formRef" inline size="small">
      ...
      <el-form-item>
        ...
        <el-button icon="Plus" @click="handleEdit">新建清廉动态</el-button>
      </el-form-item>
    </el-form>
...
const handleDelete = row => {
  ElMessageBox.alert("确定要删除该条数据?", {
    ...
    callback: action => {
      if (action === "confirm") {
        $api.actionDeleteApi({ id: row.id }).then(res => {
          if (res.code == 200) {
